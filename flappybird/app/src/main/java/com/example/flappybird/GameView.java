...
public class GameView extends View {
    ...
    private void initPipe(){
        sumpipe = 6;
        distance = 1550*Constants.SCREEN_HEIGHT/1920;
    ...
    private void initBird(){
        bird = new Bird();
        bird.setWidth(100*Constants.SCREEN_WIDTH/1060);
        bird.setHeight(100*Constants.SCREEN_HEIGHT/1350);
        bird.setX(100*Constants.SCREEN_WIDTH/1080);
        bird.setY(Constants.SCREEN_HEIGHT/2-bird.getHeight()/2);
        ArrayList<Bitmap> arrBms = new ArrayList<>();
        arrBms.add(BitmapFactory.decodeResource(this.getResources(),R.drawable.mario));
        arrBms.add(BitmapFactory.decodeResource(this.getResources(),R.drawable.mario));
    ...
    public void draw(Canvas canvas){
        ...
        if(start){
            ...
            if(bird.getY()>Constants.SCREEN_HEIGHT/2){
                bird.setDrop(-15*Constants.SCREEN_HEIGHT/1920);//fall music
            }
            bird.draw(canvas);
        }
